...
<head>
    ...
    $dbh = new PDO('mysql:host=localhost;dbname=cf756484_dms;charset=utf8mb4', 'cf444722_root', 'U7jC6Xaq');
    ?>
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr style="background-color: <?= $color[$weekday] ?>;">
                            ...
                            <td><?= $result['day'] . "(" . $week[$weekday] . ")" ?></td>
                            <?php if (!empty($result['AttendanceType']) && !empty($result['AttendanceType2'])) {
                                $attendancetype = $result['AttendanceType'] . " - " . $result['AttendanceType2'];
                            } elseif (!empty($result['AttendanceType']) && empty($result['AttendanceType2'])) {
                                $attendancetype = $result['AttendanceType'];
                            } elseif (empty($result['AttendanceType']) && !empty($result['AttendanceType2'])) {
                                $attendancetype = $result['AttendanceType2'];
                            } else {
                                $attendancetype = null;
                            }; ?>
                            ...
                            <td class="nodw">
                                <?php
                                echo $result['NumberOfDaysWorked'];
                                $nodw += $result['NumberOfDaysWorked'] ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
