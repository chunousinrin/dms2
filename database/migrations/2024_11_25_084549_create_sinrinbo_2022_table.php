...
return new class extends Migration
{
    ...
    {
        Schema::create('sinrinbo_2022', function (Blueprint $table) {
            $table->comment('令和4年度');
            $table->bigInteger('SID')->default(0)->primary();
            $table->string('ID', 15);
            $table->integer('年度');
            $table->string('計画区', 6);
            $table->string('県事務所', 7);
            ...
            $table->index(['SID', '現に所有者番号'], 'r4index');
        });
    }
    ...
    {
        Schema::dropIfExists('sinrinbo_2022');
    }
};
